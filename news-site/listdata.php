...
<div class="container">
    <h3><a href='converttoxml.php' target="_blank" style='float:right;' class='btn btn-info'>Export as Xml</a></h3><br/><br/>
	<table class="table table-striped table-bordered table-condensed">
        ...
        <?php
            ...
            $statement="select * from test where 1 order by id desc";
